...
-->
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="Admin1.html">Admin 1</a>
                    <a href="Admin2.html">Admin 2</a>
                </div>
            </div>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="wrapper">
                    <div class="left">
                        <img src="http://localhost/admin/Admin_profile/profile.jpg" alt="user" width="100">
                        <h4>Mohammad Mosiour Rahman</h4>
                        <p>MAIN ADMIN</p>
                    </div>
                    <div class="right">
                        <div class="info">
