            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">DELETE PAYMENT</h1>
                    ...
                    <div class="row">
                        ...
                        <table>
                            <tr>
                                <th style=color:yellow>serialno</th>
                                <th style=color:yellow>user</th>
                                <th style=color:yellow>post</th>
                                <th style=color:yellow>type</th>
                                <th style=color:yellow>amount</th>
                                <th style=color:yellow>donatedOn</th>
                                <th style=color:yellow>remark</th>
                  ...
                  while($data = mysqli_fetch_array($records))
                  {
                    ?>
                            <tr>
                                ...
                                <td><?php echo $data['donatedOn']; ?></td>
                                <td><?php echo $data['totalDonors']; ?></td>
                                <td><?php echo $data['remark']; ?></td>
                                <!-- <td><a href="edit.php?id=<?php echo $data['id']; ?>">Edit</a></td> -->
                                <td><a href="deletePay.php?user=<?php echo $data['user']; ?>">Delete</a></td>
                            </tr>	
                            <?php
                            }
                            ?>
