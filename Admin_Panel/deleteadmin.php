            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <table>
                        <tr>
                        <th style=color:yellow>admin_id</th>
                  ...
                  $records = mysqli_query($db,"select * from `admins`"); // fetch data from database
                  ...
                  while($data = mysqli_fetch_array($records))
                  {
                    ?>
                            <tr>
                                ...
                                <td><a href="deleteA.php?admin_id=<?php echo $data['admin_id']; ?>"><button class="btn btn-success badge-pill">Remove</button></a></td>
                            </tr>	
                            <?php
                            }
                            ?>
