                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body"><a href="updateuser.php">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    <button class="btn btn-success badge-pill"><b style=color:yellow>UPDATE USER</b></button>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                    ...
                                    <div class="card-body"><a href="blog.php">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    ...
                                                    <button class="btn btn-success badge-pill"><b style=color:yellow>UPDATE BLOG</b></button>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body"><a href="comment.php">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    <button class="btn btn-success badge-pill"><b style=color:yellow>UPDATE COMMENT</b></button>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body"><a href="post.php">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    <button class="btn btn-success badge-pill"><b style=color:yellow>UPDATE POST</b></button>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                ...
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body"><a href="payment.php">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    <button class="btn btn-success badge-pill"><b style=color:yellow>UPDATE PAYMENT</b></button>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body"><a href="adminList.php">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    <button class="btn btn-success badge-pill"><b style=color:yellow>UPDATE ADMIN</b></button>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                                    <i class="fas fa-user fa-2x text-red-300"></i>
