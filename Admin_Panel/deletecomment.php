            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">DELETE COMMENT</h1>
                  ...
                  $records = mysqli_query($db,"select * from `comments`"); // fetch data from database
                  ...
                  while($data = mysqli_fetch_array($records))
                  {
                    ?>
                            <tr>
                                ...
                                <td><?php echo $data['cmnttext']; ?></td>
                                <!-- <td><a href="edit.php?id=<?php echo $data['id']; ?>">Edit</a></td> -->
                                <td><a href="deleteC.php?username=<?php echo $data['username']; ?>">Delete</a></td>
                            </tr>	
                            <?php
                            }
                            ?>
