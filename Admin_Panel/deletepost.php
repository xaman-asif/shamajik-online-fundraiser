        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  $records = mysqli_query($db,"select * from `posts`"); // fetch data from database
                  ...
                  while($data = mysqli_fetch_array($records))
                  {
                    ?>
                            <tr>
                                ...
                                <td><?php echo $data['fundNeeded']; ?></td>
                                <td><?php echo $data['fundRaised']; ?></td>
                                <td><?php echo $data['totalDonors']; ?></td>
                                <td><?php echo $data['location']; ?></td>
                                <td><?php echo $data['catagory']; ?></td>
                                <td><?php echo $data['enddate']; ?></td>
                                <td><?php echo $data['image']; ?></td>
                                <td><a href="deleteP.php?user=<?php echo $data['user']; ?>"><button class="btn btn-success badge-pill">Delete</button></a></td>
                            </tr>	
                            <?php
                            }
                            ?>
