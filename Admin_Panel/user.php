                        ...
                        <table>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr><td>" . $row["username"] . "</td><td>" . $row["userrole"] .  "</td><td>" . $row["raised"] . "</td><td>" . $row["funded"] . "</td><td>" . $row["fullname"] . "</td><td>" . $row["contact"] . "</td><td>" . $row["location"] . "</td></tr>";
...
-->
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body"><a href="http://localhost/Admin_Panel/post.php">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                <b>POST</b></div>
